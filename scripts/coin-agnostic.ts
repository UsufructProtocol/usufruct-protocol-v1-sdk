...
async function main() {
  ...
  check('escrow.floorPrice mist is exact (0.5 USDC = 500000)', floorPrice.mist === 500_000n, `${floorPrice.mist}`);
  check('escrow.floorPrice RENDERS as 0.50 USDC (not 9-decimal coupled)', floorPrice.toString() === '0.50 USDC', floorPrice.toString());
